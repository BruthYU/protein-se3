...
| Genie1      | ![Star](https://img.shields.io/github/stars/aqlaboratory/genie?style=social&label=Star) <br> [**Genie: De Novo Protein Design by Equivariantly Diffusing Oriented Residue Clouds**](https://arxiv.org/abs/2301.12485) <br>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |   ICML    | 2023-06-26 |                                                           [Github](https://github.com/aqlaboratory/genie)                                                           |
...
**You can also directly download our preprocessed dataset at [Harvard Dataverse](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/FADHRC)**
...
Training and inference of all integrated methods are implemented in the lightning workspace (`protein-se3\lightning`). You can refer to this  [README.md](lightning/README.md) for more details.
